    ...
    >
      ...
      <Drawer variant="permanent" open={open}>
        ...
        >
          ...
          <List>
            <ListItem key="diagnosis" disablePadding sx={{ display: "block" }}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  px: 2.5,
              ...
              >
                <Link underline="none" href="/diagnosis/new-patient">
      ...
      >
        <BrowserRouter>
          <Routes>
            ...
            />
            <Route path="/diagnosis/profile" element={<Profile />} />
            <Route path="/diagnosis/chat" element={<Chat />} />
