    ...
    >
      ...
      <Drawer variant="permanent" open={open}>
        ...
        >
          ...
          <List>
            <ListItem key="lab" disablePadding sx={{ display: "block" }}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  px: 2.5,
              ...
              >
                <Link underline="none" href="/lab/new-patient">
                ...
                <Link underline="none" href="/lab/new-patient" color="inherit">
