...
import Periatric from "./periatric";
import Geriatric from "./geriatric";
import Adult from "./adult";
import Neonatal from "./neonatal";

const drawerWidth = 240;

//list of drawer (side nav) elements
const drawerElements = [
  {
    label: "New patients",
    icon: <PersonAddAltIcon />,
    link: "/",
    infoText: "New patients",
  },
  {
    label: "All patients",
    icon: <Diversity3Icon />,
    link: "/opd/all-patients",
    infoText: "All patients",
  },
  {
    label: "Periatric patients",
    icon: <Diversity3Icon />,
    link: "/opd/periatric",
    infoText: "Periatric patients",
  },
  {
    label: "Adult pateints",
    icon: <Diversity3Icon />,
    link: "/opd/adult",
    infoText: "Adult patients",
  },
  {
    label: "Geriatric patients",
    icon: <Diversity3Icon />,
    link: "/opd/geriatric",
    infoText: "Geriatric pateints",
  },
  {
    label: "Neonatal patients",
    icon: <Diversity3Icon />,
    link: "/opd/neonatal",
    infoText: "Neonatal patients",
  },
];
      ...
      >
        <BrowserRouter>
          <Routes>
            ...
            />
            <Route path="/opd/profile" element={<Profile />} />
            <Route path="/opd/chat" element={<Chat />} />
